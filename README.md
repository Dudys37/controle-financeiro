...
17. 🔜 **Compras & Desejos** (evolução do Hobbies, com análise de impacto e relação com metas/reserva), **Relatórios + PDFs**, **Integrações** (ver tabela abaixo), e migração gradual de handlers inline legados.
