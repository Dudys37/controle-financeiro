...
21. 🔜 **Próximos módulos e backend** — Carreira e Patrimônio (ainda placeholders), Relatório de Trabalho avançado (Kanban/calendário), Open Finance via provedor, Gmail/Calendar real com OAuth, B3 com proxy, notificações push, anexos via Firebase Storage, e migração gradual de handlers inline legados.
