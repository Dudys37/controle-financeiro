...
24. 🔜 **Backend & melhorias futuras** — próximos passos de modularização (`constants.js`, `reports.js`, `integrations.js`, migração gradual de handlers inline), e integrações que exigem backend leve: anexos via Firebase Storage, FIPE/mercado, Open Finance, Gmail/Calendar real com OAuth, B3 com proxy e push.
