...
22. 🔜 **Próximos módulos e backend** — Patrimônio (ainda placeholder), visões Kanban/calendário, Open Finance via provedor, Gmail/Calendar real com OAuth, B3 com proxy, notificações push, anexos via Firebase Storage, e migração gradual de handlers inline legados.
